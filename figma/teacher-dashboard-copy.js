...
function OpenModal(id, studentID = "-1") {
    console.log('OpenModal called with id:', id, 'and studentID:', studentID);
}
...
const Checkbox = (props) => {
    return (
        <section className="modal-text-input">
            ...
            <input className="modal-text-input" type="checkbox" id={props.id} name={props.name} value={props.title} />
        </section>
    );
}
...
ReactDOM.render(<EditStudentInput />, document.getElementById("edit-student-modal-root"));
    ...
    if (items.length == 0) {
        return (
            <section>
                ...
                <p className="classes-memo">Select a class to view students</p>
...
function Indicator(props) {
    return (
        <section>
            <div className="row">
                <div>
                    <div className={`upper-info-icon-shape ${props.theme}`}></div>
        ...
        <li>
            <div className="student-list-item">
                ...
                <div>
                    ...
                    <p className="student-info-body">{props.data.parent_contact}</p>
                </div>
                <div>
                    <p className="student-info-body">Edit</p>
                </div>
            </div>
        </li>
    );
...
function AddStudents(props) {
    ...
    if (items.length == 0) {
        return (
            <div>
                <h1 className="students-title">{selectedClass.class_name}</h1>
                <p className="students-memo">Students</p>
                <ul className="nobullet">
